...
/**
 * Provides drawing instructions for a GLSurfaceView object. This class must override the OpenGL ES drawing lifecycle
 * methods:
 * <ul>
...
public class EveryplayRecordRenderer implements GLSurfaceView.Renderer {
    ...
    private static final String vertexShaderCode = "attribute vec4 position;" + "attribute vec4 color;" + "varying vec4 colorVarying;"
        + "uniform float translate;" + "void main() {" + "    gl_Position = position;" + "    gl_Position.y += sin(translate) / 2.0;"
        + "    gl_Position.x += cos(translate) * 0.5;" + "    colorVarying = color;" + "}";

    private static final String fragmentShaderCode = "varying lowp vec4 colorVarying;" + "void main() {"
    ...
    private static byte[] squareColorsArray = {maxColor, maxColor, 0, maxColor, 0, maxColor, maxColor, maxColor, 0, 0, 0, maxColor,
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig config) {
        ...
        ByteBuffer squareVerticesBuf = ByteBuffer.allocateDirect(squareVerticesArray.length * 4);
     ...
     * ERGLRenderer.checkGlError(&quot;glGetUniformLocation&quot;);
     * </pre>
     *
